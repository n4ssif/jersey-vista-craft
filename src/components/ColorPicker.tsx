...
export const ColorPicker: React.FC<ColorPickerProps> = ({ config, updateConfig }) => {
  const colorPresets = [
    ...
    { name: 'Black & Yellow', primary: '#000000', secondary: '#fbbf24', accent: '#ffffff' },
    { name: 'Navy & Red', primary: '#1e3a8a', secondary: '#dc2626', accent: '#ffffff' },
    { name: 'Forest & Cream', primary: '#166534', secondary: '#fef3c7', accent: '#f59e0b' },
  ];
